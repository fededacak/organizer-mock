    ...
    <footer className="w-full bg-white dark:bg-[#0a0a0f] border-t border-light-gray dark:border-[#2a2a35] transition-colors duration-300 ease-out">
      <div className="max-w-[1000px] mx-auto px-4 sm:px-6">
        ...
        <div className="py-8 sm:py-10">
          {/* Mobile: Logo + App Downloads centered */}
          <div className="flex flex-col items-center gap-6 mb-8 md:hidden">
            ...
            {/* App Downloads - horizontal on mobile */}
            <div className="flex flex-row gap-3">
              {/* App Store */}
              <a
                href="#"
                className="w-[135px] h-[44px] bg-black dark:bg-white rounded-lg flex items-center px-2.5 gap-2"
              >
                <svg
                  width="18"
                  height="22"
              ...
              >
                <svg
                  ...
                  className="shrink-0"
                >
                  <path d="M1 1.5L14 13.5L1 25.5V1.5Z" fill="#00D9FF" />
                  <path d="M14 13.5L18 10L5 2L14 13.5Z" fill="#00FF85" />
                  <path d="M14 13.5L18 17L5 25L14 13.5Z" fill="#FF3B3B" />
                  <path d="M18 10L22 12.5L18 17L14 13.5L18 10Z" fill="#FFCF00" />
                </svg>
                <div className="flex flex-col text-white dark:text-black">
                  <span className="text-[9px] uppercase leading-tight">Get it on</span>
            ...
            <div className="flex items-center gap-2">
              <div className="flex gap-0.5">
                {[1, 2, 3, 4, 5].map((i) => (
                  <svg key={i} width="12" height="14" viewBox="0 0 12 14" fill="#FFB222">
          ...
          {/* Mobile: Link columns in 2-column grid */}
          <div className="grid grid-cols-2 gap-6 md:hidden">
            {/* Company Links */}
            <div className="flex flex-col gap-2">
              <p className="font-bold text-sm text-black dark:text-white">Company</p>
              <div className="flex flex-col gap-1.5">
                {COMPANY_LINKS.map((link) => (
                  <a
                    key={link}
                    href="#"
                    className="text-xs text-neutral-600 dark:text-[#9ca3af] hover:text-black dark:hover:text-white transition-colors"
                  >
                    {link}
                  </a>
                ))}
            ...
            {/* Promise Links */}
            <div className="flex flex-col gap-2">
              <p className="font-bold text-sm text-black dark:text-white">Our Promise</p>
              <div className="flex flex-col gap-1.5">
          ...
          <div className="hidden md:flex flex-wrap justify-between gap-8">
            {/* Logo */}
            <div className="w-[190px] text-black dark:text-white">
            ...
            <div className="flex flex-col items-center gap-3">
              <div className="flex flex-col gap-3">
                ...
                <a
                  href="#"
                  className="w-[152px] h-[51px] bg-black dark:bg-white rounded-md flex items-center px-2 gap-2"
                >
                  <svg
                    width="22"
                    height="27"
                ...
                >
                  ...
                  <div className="flex flex-col text-white dark:text-black">
                    <span className="text-[11px] uppercase leading-tight">Get it on</span>
        ...
        {/* Copyright */}
        <div className="border-t border-light-gray dark:border-[#2a2a35] py-5 flex flex-col sm:flex-row items-center sm:justify-between gap-4">
          {/* Social Icons - first on mobile */}
          <div className="flex items-center gap-3 order-first sm:order-last">
            {/* Instagram */}
            <a
              href="#"
              className="w-[36px] h-[36px] sm:w-[30px] sm:h-[30px] rounded-lg bg-linear-to-br from-purple-500 via-pink-500 to-orange-400 flex items-center justify-center"
            >
            ...
            <a
              href="#"
              className="w-[36px] h-[36px] sm:w-[30px] sm:h-[30px] rounded-lg bg-red-600 flex items-center justify-center"
            >
              <svg width="18" height="18" viewBox="0 0 24 24" fill="white">
            ...
            <a
              href="#"
              className="w-[36px] h-[36px] sm:w-[30px] sm:h-[30px] rounded-full bg-blue-600 flex items-center justify-center"
            >
              <svg width="18" height="18" viewBox="0 0 24 24" fill="white">
            ...
            <a
              href="#"
              className="w-[36px] h-[36px] sm:w-[30px] sm:h-[30px] rounded-full bg-black dark:bg-white flex items-center justify-center"
            >
              <svg
                width="14"
                height="14"
          ...
          <div className="text-xs sm:text-sm text-dark-gray dark:text-[#9ca3af] text-center sm:text-left">
